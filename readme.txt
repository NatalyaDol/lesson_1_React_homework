...
Каждое задание в отдельном файле js.
Задание 2 можно посмотреть также на уровне index.html
Остальные задания в рамках консоли


!!!!!!! конец комментария !!!!!!!


1. Написать функцию loop, которая будет принимать 
...
класса Employee написать: super.displayInfo(), это вызовет метод disaplyInfo класс Human 
и вернет строку с параметрами Human'a.

4*. Написать цикл, который создаёт массив промисов, внутри каждого промиса происходит 
